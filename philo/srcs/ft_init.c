...
/*   Updated: 2022/05/23 10:43:54 by jtaravel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_manage	*ft_init_struct_2(t_global *global)
{
	...
	while (i < global->n_philo)
	{
		...
		pthread_mutex_init(&manage[i].nbr_eat, NULL);
...
void	ft_init_struct(t_global *global, char **av, int ac)
{
	...
	if (ac == 6)
	{
		...
		global->multi = global->each_time_eat * global->n_philo;
	}
